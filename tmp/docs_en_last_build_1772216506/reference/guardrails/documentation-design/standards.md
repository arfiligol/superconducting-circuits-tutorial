...
!!! warning "Name validation"
    Any **person name** referenced in `owner` or `updated_by` must exist in the [Contributors Registry](../../contributors.md). Add new contributors before referencing them.
