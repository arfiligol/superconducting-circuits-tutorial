...
- **Hand-written**: keep only common tasks and high-frequency scenarios (concise first).
- **Reference**: must cover all commands/parameters/outputs with full accuracy.
- **How-to**: only include common tasks; do not cover every feature.
...
See: [CLI Docs Automation](../../../how-to/contributing/cli-docs-automation.en.md)
